...
class ProductControllerTest extends ControllerTest {
    ...
    void shouldReturnBadRequestWhenGettingProductsWithInvalidUri(String uri, String message) throws Exception {
        perform(GET, "/products" + uri).andExpectAll(status().isBadRequest(), content().string(message));
    }
}
