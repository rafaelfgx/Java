...
class MapperServiceTest {
    ...
    @Test
    void shouldReturnNullWhenConvertingNullSourceToJson() throws JsonProcessingException {
        Assertions.assertNull(mapperService.toJson(null));
    }

    @Test
    void shouldReturnNotNullWhenConvertingNonNullSourceToJson() throws JsonProcessingException {
    ...
    @Test
    void shouldReturnNullWhenConvertingNullJsonToEntity() throws JsonProcessingException {
        Assertions.assertNull(mapperService.fromJson(null, Entity.class));
    }

    @Test
    void shouldReturnEqualEntityWhenConvertingNonNullJsonToEntity() throws JsonProcessingException {
        final var expected = getEntity();
